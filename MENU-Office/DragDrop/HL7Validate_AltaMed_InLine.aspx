...
<asp:Panel ID="pnPager" runat="server">
    ...
    <div class="container" style="padding-left: 40px;">
      ...
      <ul class="list-group">
        <li class="list-group-item col-sm-10">/users/69 altamed/incoming/ <span class="right label label-primary">incoming FTP folder</span></li>
        <li class="list-group-item col-sm-10">CO_AltaMed_HL7_05232019_01_batID=122177,_ftpID=2;.txt  <span class="right label label-primary">sample file name</span></li>
        <li class="list-group-item col-sm-10">\\bt2010pr1\Integration\Inbox\Data\ <span class="right label label-success">drop folder</span></li>
        <li class="list-group-item col-sm-10">\\bt2010pr1\Integration\Inbox\Archive\2019\06\CO_AltaMed_HL7_05232019_01_batID=122177,_ftpID=2;.txt <span class="right label label-warning">archive folder</span></li>
      </ul>
    </div>
    ...
    <div style="padding-top: 20px; padding-left: 40px;">
      <table>
         <tr>
             <td><B>result saved folder :</B> &nbsp;</td>
             <td><input type="text" id="savedFolder" style="width:800px;" value="\\optima\group\IS\EDI\Michael.Lee\Temp\"></td>
         </tr>
      </table>
    </div>
